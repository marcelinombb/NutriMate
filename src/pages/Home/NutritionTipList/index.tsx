import { Text, FlatList, View, ImageBackground, ImageSourcePropType } from 'react-native'
            ...
            <ChallengeCard width={width * 0.8}>
                <ImageBackground source={item.background} resizeMode="cover" style={{ flex: 1, overflow: 'hidden', borderRadius: 20}}>
                    <View style={{
                        ...
                        <ChallengeMoreButton>
                            <Text style={{ color: "#00000", fontWeight: "500", fontSize: 16}}>More ></Text>
                        </ChallengeMoreButton>
                    </View>
                </ImageBackground>
            </ChallengeCard>
    ...
    return (
        <View style={{marginTop:40}}>
            <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: 20, paddingBottom: 10 }}>
                <Text style={{ fontWeight: "bold", fontSize: 24, color: "#000000"}}>Challenges</Text>
