...
import { CenterSubTitle, CenterTitle, Container, IndicatorContainer, Section, SideSubTitle, SideTitle } from './styles'
          ...
          return (
            <RecipeCard isLast={index === data.length - 1} height={74}>
              ...
              <View style={{ flex: 1, width: 'auto', marginLeft: 15, marginRight: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <View style={{}}>
                  <TouchableOpacity>
                    <Image source={PlusCircleIcon} style={{ width: 35, height: 35 }} />
                  </TouchableOpacity>
                </View>
              </View>
            </RecipeCard>
